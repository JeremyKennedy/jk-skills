...
| `claude-md-management@*` | jk-remember, jk-execute (knowledge promotion) | jk-remember routes knowledge to agent instructions, docs/, or memory. jk-execute's knowledge promotion updates agent instructions and docs/ after execution. The revise-claude-md command is subsumed by jk-remember's broader routing. |
