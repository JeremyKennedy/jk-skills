...
---
<!-- Derived from superpowers v4.2.0: writing-skills -->
...
**REQUIRED BACKGROUND:** You MUST understand jk-skills:test-driven-development before using this skill. That skill defines the fundamental RED-GREEN-REFACTOR cycle. This skill adapts TDD to documentation.
...
**Every new skill must embody the development philosophy (jk-skills:jk-philosophy).** Before deploying, verify:

- [ ] **Code is free:** Does the skill encourage rewriting over preserving? Does it treat sunk cost as irrelevant?
- [ ] **Expand scope:** Does the skill encourage fixing adjacent issues, not just the narrow task?
- [ ] **Refactor always:** Does the skill promote leaving code cleaner, not just correct?
- [ ] **Ask more questions:** Does the skill push for deeper understanding, not surface fixes?
- [ ] **TDD when building features:** If the skill involves implementation, does it require test-first?
- [ ] **Envision ideal end state:** Does the skill push toward the right solution, not the expedient one?
- [ ] **Delete aggressively:** Does the skill avoid preserving things out of inertia?

If a skill contradicts any of these principles, rewrite it until it aligns. Skills that don't match the philosophy will produce work that doesn't match the philosophy.
...
skills/
  skill-name/
    ...
    references/           # Supporting files (if needed)
      supporting-file.*
```
...
Use words an agent would search or match for:
...
- Good: `**REQUIRED SUB-SKILL:** Use jk-skills:test-driven-development`
- Good: `**REQUIRED BACKGROUND:** You MUST understand jk-skills:systematic-debugging`
...
**REQUIRED BACKGROUND:** The jk-skills:test-driven-development skill explains why this matters. Same principles apply to documentation.
...
- [ ] **Philosophy alignment checklist passes** (see above)
